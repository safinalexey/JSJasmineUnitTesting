...
describe("A spec testing PieChartModel getItems() function", function () {
    ...
    pmCorrectInput = new PieChartModel([
        {name: "a", value: 100}
    ]);

    pmValLower100 = new PieChartModel([
        {name: "a", value: 50}
    ]);

    pmValOver100 = new PieChartModel([
        {name: "a", value: 101}
    ]);

    pmTwoValsCoorectInput = new PieChartModel([
        {name: "a", value: 50},
        {name: "b", value: 50}
    ]);
    pmTwoValsCoorectInputItems = pmTwoValsCoorectInput.getItems();
...
//        expect(pmCorrectInput.getItems()).toContain({
//            id       : 0,
//            modelItem: {
//                name : "a",
//                value: 100
...
//            angEnd   : 6.283185307179587})
        expect(pmCorrectInput.getItems()).toEqual(jasmine.objectContaining({
            value: 100,
            angEnd: 2 * Math.PI
        }))
    });
    ...
    it("with input value lower 100", function () {
        expect(pmValLower100.getItems()).toContain({
            id       : 1,
            modelItem: {
                name : "a",
                value: 100
    ...
    it("with input value over 100", function () {
        expect(pmValOver100.getItems()).toContain({
            id       : 2,
            modelItem: {
                name : "a",
                value: 100
    ...
    it("with inputs value sum eq 100", function () {
        expect(pmTwoValsCoorectInputItems).toEqual([
            {
                id       : 3,
                modelItem: {
                    name : "a",
...
describe("A spec testing PieChartModel setAngleEnd() function", function () {
    ...
    pm = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
    ...
    it("with correct input more than angStart, must pass", function () {
        var pm = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
...
describe("A spec testing PieChartModel changeStrategy() function", function () {
    pmToChgStr = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
    ...
    newPm = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
    ...
    newPmToChgStr = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
...
describe("A spec testing PieChartModel remove() function", function () {
    ...
    var pmRm = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
...
describe("A spec testing PieChartModel reset() function", function () {
    ...
    var pmRs = new PieChartModel([{name: "a", value: 43}, {name: "b", value: 38}, {name: "c", value: 15}]);
    ...
    var pmSE = new PieChartModel([{name: "a", value: 43}]);
...
describe("A spec testing PieChartHistory", function () {
    var pm = new PieChartModel([{name: "a", value: 20}, {name: "b", value: 20}, {name: "c", value: 20}, {name: "d", value: 20}, {name: "e", value: 20}]);
